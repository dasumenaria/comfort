    ...
    <div class="col-md-12">
        <div class="box box-primary"> 
            <div class="box-header with-border">
                <i class="fa fa-plus"></i>Dutyslip Edit
            </div>
            ...
            <div class="box-body">
                ...
                <div class="CorporateBilling">
                    ...
                    <div class="row container" style="margin: auto;">
                        ...
                        <div class="col-md-4">
                            <?php echo $this->Form->control('service_date',['label' => false,'class' => 'form-control date-picker','placeholder'=>'DD-MM-YYYY','autocomplete'=>'off','data-date-format'=>'dd-mm-yyyy','type'=>'text','value'=>date('d-m-Y',strtotime($dutySlip->date))]); ?> 
                        </div>
                    </div>
                </div>
