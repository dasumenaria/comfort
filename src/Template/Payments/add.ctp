                            ...
                            <tbody id='MainTbody' class="tab">
                                <tr class="MainTr">
                                    ...
                                    <td width="65%" valign="top">
                                        <?php echo $this->Form->input('ledger_id', ['empty'=>'--Select--','options'=>@$ledgerOptions,'label' => false,'class' => 'form-control input-sm ledger select2','required'=>'required']); ?>
...
$(document).ready(function() {
    ...
    $(document).on('change','.refType',function(){ 
        ...
        if(type=='Against'){
            ...
            currentRefRow.find('td:nth-child(5)').html('<input type="text" class="form-control input-sm rightAligntextClass dueDays " placeholder="Due Days" title="Due Days">');
