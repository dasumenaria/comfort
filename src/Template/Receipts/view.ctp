...
<div  class="maindiv" style="border:solid 1px #c7c7c7;background-color: #FFF;padding: 10px;margin: auto;width:75%;font-size: 12px;">    
    ...
    <table width="100%">
            ...
            <td width="50%" valign="top" align="left">
                <table>
                    <tr>
                        ...
                        <td><?= h(str_pad($receipts->voucher_no, 4, '0', STR_PAD_LEFT)) ?></td>
                    </tr>
                </table>
            </td>
            <td width="50%" valign="top" align="right">
                <table>
                    <tr>
                        ...
                        <td width="20" align="center">:</td>
                        <td><?= h(date("d-m-Y",strtotime($receipts->transaction_date))) ?></td>
                    </tr>
                </table>
            </td>
        </tr>
    </table>
        Narration: <?php echo $receipts->narration;?>
        <br/><br/>
        <table width="100%" class="table" style="font-size:12px">
            ...
            <?php foreach($receipts->receipt_rows as $receipt_row)
                { 
                    @$total_debit+=$receipt_row->debit;
                    @$total_credit+=$receipt_row->credit; ?>
                    <tr>
                    <td colspan="3" style="text-align:left"><b><?=$receipt_row->ledger->name?></b>
