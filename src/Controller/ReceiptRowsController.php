 ...
 *
 * @method \App\Model\Entity\ReceiptRow[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class ReceiptRowsController extends AppController
{
    ...
    public function view($id = null)
    {
        $receiptRow = $this->ReceiptRows->get($id, [
            'contain' => ['Receipts', 'Companies', 'Ledgers', 'AccountingEntries', 'ReferenceDetails']
        ]);
